...
For corresponding images, refer to the following html file in the zip.
...
Pooling. The output shapeis 14x14x6.
Layer 2: Convolutional. The output shape is 10x10x16.
Activation. Your choice of activation function.
Pooling. The output shape is 5x5x16.
Flatten. Flatten the output shape of the final pooling layer using tf.contrib.layers.flatten.
...
* training set accuracy of = 0.9895
* validation set accuracy of Validation Accuracy = 0.9840
* test set accuracy of Test accuracy on new images = 0.957
